/**
 */
package eu.megamart2.papyrus.profiles.alf.BackupProfile.util;
 ...
 * @generated
 */
public class BackupProfileSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static BackupProfilePackage modelPackage;
	 ...
	 * @generated
	 */
	public BackupProfileSwitch() {
		if (modelPackage == null) {
			modelPackage = BackupProfilePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BackupProfilePackage.BACKUP: {
