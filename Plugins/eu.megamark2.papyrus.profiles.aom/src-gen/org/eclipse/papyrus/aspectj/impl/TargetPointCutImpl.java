 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.aspectj.impl.TargetPointCutImpl#getBase_StructuralFeature <em>Base Structural Feature</em>}</li>
 *   <li>{@link org.eclipse.papyrus.aspectj.impl.TargetPointCutImpl#getArgNames <em>Arg Names</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TargetPointCutImpl extends TypePointCutImpl implements TargetPointCut {
	/**
		...
		if (base_StructuralFeature != null && base_StructuralFeature.eIsProxy()) {
			...
			if (base_StructuralFeature != oldBase_StructuralFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AspectJPackage.TARGET_POINT_CUT__BASE_STRUCTURAL_FEATURE, oldBase_StructuralFeature, base_StructuralFeature));
			}
		}
	...
	public void setBase_StructuralFeature(StructuralFeature newBase_StructuralFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AspectJPackage.TARGET_POINT_CUT__BASE_STRUCTURAL_FEATURE, oldBase_StructuralFeature, base_StructuralFeature));
	}
	...
	public EList<String> getArgNames() {
		if (argNames == null) {
			argNames = new EDataTypeUniqueEList<String>(String.class, this, AspectJPackage.TARGET_POINT_CUT__ARG_NAMES);
		}
		return argNames;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AspectJPackage.TARGET_POINT_CUT__BASE_STRUCTURAL_FEATURE:
				if (resolve) return getBase_StructuralFeature();
				return basicGetBase_StructuralFeature();
			case AspectJPackage.TARGET_POINT_CUT__ARG_NAMES:
				return getArgNames();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == ArgumentDefiningPointCut.class) {
			switch (derivedFeatureID) {
				case AspectJPackage.TARGET_POINT_CUT__BASE_STRUCTURAL_FEATURE: return AspectJPackage.ARGUMENT_DEFINING_POINT_CUT__BASE_STRUCTURAL_FEATURE;
				case AspectJPackage.TARGET_POINT_CUT__ARG_NAMES: return AspectJPackage.ARGUMENT_DEFINING_POINT_CUT__ARG_NAMES;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == ArgumentDefiningPointCut.class) {
			switch (baseFeatureID) {
				case AspectJPackage.ARGUMENT_DEFINING_POINT_CUT__BASE_STRUCTURAL_FEATURE: return AspectJPackage.TARGET_POINT_CUT__BASE_STRUCTURAL_FEATURE;
				case AspectJPackage.ARGUMENT_DEFINING_POINT_CUT__ARG_NAMES: return AspectJPackage.TARGET_POINT_CUT__ARG_NAMES;
				default: return -1;
			}
		}
