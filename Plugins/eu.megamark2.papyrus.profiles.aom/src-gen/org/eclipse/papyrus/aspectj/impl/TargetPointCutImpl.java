...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Target Point Cut</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.aspectj.impl.TargetPointCutImpl#getBase_PointCut_StructuralFeature <em>Base Point Cut Structural Feature</em>}</li>
 *   <li>{@link org.eclipse.papyrus.aspectj.impl.TargetPointCutImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TargetPointCutImpl extends ArgumentDefiningPointCutImpl implements TargetPointCut {
	/**
	...
	protected EClass eStaticClass() {
		return AspectJPackage.Literals.TARGET_POINT_CUT;
	}
		...
		if (base_PointCut_StructuralFeature != null && base_PointCut_StructuralFeature.eIsProxy()) {
			...
			if (base_PointCut_StructuralFeature != oldBase_PointCut_StructuralFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AspectJPackage.TARGET_POINT_CUT__BASE_POINT_CUT_STRUCTURAL_FEATURE, oldBase_PointCut_StructuralFeature, base_PointCut_StructuralFeature));
			}
		}
	...
	public void setBase_PointCut_StructuralFeature(StructuralFeature newBase_PointCut_StructuralFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AspectJPackage.TARGET_POINT_CUT__BASE_POINT_CUT_STRUCTURAL_FEATURE, oldBase_PointCut_StructuralFeature, base_PointCut_StructuralFeature));
	}
	...
	public EList<Type> getType() {
		if (type == null) {
			type = new EObjectResolvingEList<Type>(Type.class, this, AspectJPackage.TARGET_POINT_CUT__TYPE);
		}
		return type;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AspectJPackage.TARGET_POINT_CUT__BASE_POINT_CUT_STRUCTURAL_FEATURE:
				if (resolve) return getBase_PointCut_StructuralFeature();
				return basicGetBase_PointCut_StructuralFeature();
			case AspectJPackage.TARGET_POINT_CUT__TYPE:
				return getType();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == PointCut.class) {
			switch (derivedFeatureID) {
				case AspectJPackage.TARGET_POINT_CUT__BASE_POINT_CUT_STRUCTURAL_FEATURE: return AspectJPackage.POINT_CUT__BASE_POINT_CUT_STRUCTURAL_FEATURE;
				default: return -1;
			}
		}
		if (baseClass == TypePointCut.class) {
			switch (derivedFeatureID) {
				case AspectJPackage.TARGET_POINT_CUT__TYPE: return AspectJPackage.TYPE_POINT_CUT__TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PointCut.class) {
			switch (baseFeatureID) {
				case AspectJPackage.POINT_CUT__BASE_POINT_CUT_STRUCTURAL_FEATURE: return AspectJPackage.TARGET_POINT_CUT__BASE_POINT_CUT_STRUCTURAL_FEATURE;
				default: return -1;
			}
		}
		if (baseClass == TypePointCut.class) {
			switch (baseFeatureID) {
				case AspectJPackage.TYPE_POINT_CUT__TYPE: return AspectJPackage.TARGET_POINT_CUT__TYPE;
				default: return -1;
			}
		}
